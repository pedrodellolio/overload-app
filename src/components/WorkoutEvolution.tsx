...
export const WorkoutEvolution = () => {
  ...
  return (
    <div className="bg-base-200 rounded-md p-6 border border-base-300">
      <h2 className="text-lg font-semibold mb-4">Workout Evolution</h2>
        ...
        Object.keys(groupedByExercise).length > 0 && (
          <div className="space-y-6 mt-6">
            {Object.entries(groupedByExercise).map(([exerciseTitle, exerciseData]) => {
              ...
              return (
                <div key={exerciseTitle} className="border-t border-base-300 pt-4 first:border-t-0 first:pt-0">
                    ...
                    <div className="flex gap-3 text-sm">
                      ...
                      <div className="text-right">
                        ...
                        <p className="font-bold">
                          {exerciseData[exerciseData.length - 1].load_in_kg} kg
                        </p>
                      </div>
                      <div className="text-right">
                  ...
                  <ChartContainer config={chartConfig} className="h-52 sm:h-56 w-full">
